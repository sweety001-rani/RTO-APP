...
import services.Interface_RTO_Update_detail;

import java.sql.*;
import java.util.*;

public class
RTO_Update_detail implements Interface_RTO_Update_detail {
        ...
        while (exit_update == true) {
            ...
            switch (update_choice) {
                ...
                case "2": {
                    ...
                    sql = "update registration set puc =? where number_plate=?";
                    PreparedStatement pst = j.Connection2().prepareStatement(sql);
